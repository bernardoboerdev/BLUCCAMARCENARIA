...
export function FAQItem({ question, answer }: FAQItemProps) {
  ...
  return (
    <div className="border-b border-gray-200 py-4">
      ...
      >
        <span className="text-base sm:text-lg font-semibold text-left">{question}</span>
      ...
      >
        <div className="text-gray-700 text-base sm:text-xl leading-relaxed text-left">{answer}</div>
      </div>
    </div>
  )
}
